...
@onready var left_panel = $VBoxContainer/PanelsContainer/LeftPanel
@onready var right_panel = $VBoxContainer/PanelsContainer/RightPanel
...
func get_active_panel():
	return active_panel == left_panel if "left" else right_panel
